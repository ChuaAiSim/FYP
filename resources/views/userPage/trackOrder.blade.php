	...
	<div class="container-fluid" style="margin-top: 80px;background-color: white">
			<h2 style="margin:20px;color: black;font-weight: bold">Track My Orders</h2>
			...
			<table class="table table-hover table-bordered" width="90%" cellspacing="0" style="text-align:center;background-color: #3a8fb759;color: black">
				...
				<tbody>
					...
					<tr>
						...
						?></td>
						<td>
							<a href="{{ route('trackOrderDetails', ['oId' => $order->id]) }}"><button type="button" class="btn btn-dark" style="text-align: center;width: 100%">View Details</button></a>
						</td>
					</tr>
					@endforeach
				</tbody>
